...
export default function Header({ options }) {
	...
	return (
		<header className="bg-blue-100 shadow-md sticky top-0 z-50 transition-all duration-300 border-2 border-red-600 border-dashed">
			<div className="container mx-auto px-4 py-4 flex justify-between items-center">
				<Link href="/" className="flex items-center space-x-2 group">
					<div className="w-24 h-w-24 animate-spin-slow">
