...
export default function ProductDetailPage() {
	...
	if (!product) {
		return (
			<div className="flex flex-col items-center justify-center h-screen border-4 border-dashed border-red-600 bg-gradient-to-br from-yellow-200 to-orange-400">
	...
	return (
		<div className="border-4 border-dashed border-red-600 bg-gradient-to-br from-yellow-200 to-orange-400">
